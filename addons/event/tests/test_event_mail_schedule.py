...
>>>>>>> upstream/18.0
    ...
    def test_scheduler_on_done_event(self):
        ...
        with self.mock_datetime_and_now(event_date_end + relativedelta(hours=1)), self.mock_mail_gateway():
            event_cron_id.method_direct_trigger()
        ...
        with self.mock_datetime_and_now(event_date_end + relativedelta(hours=3)), self.mock_mail_gateway():
            event_cron_id.method_direct_trigger()
