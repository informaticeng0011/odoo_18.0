...
=======
>>>>>>> upstream/18.0
    def _ubl_is_global_discount_base_line(self, base_line):
...
=======
>>>>>>> upstream/18.0
    def _ubl_default_allowance_charge_global_discount_grouping_key(self, base_line, tax_data, vals, currency):
        ...
        :return:            A dictionary that could be used as a grouping key for the taxes helpers.
        """
        if not self._ubl_is_global_discount_base_line(base_line):
            return
...
=======
>>>>>>> upstream/18.0
    def _ubl_get_allowance_charge_global_discount_tax_category_node(self, vals, tax_category):
        return {
            '_currency': tax_category['currency'],
            'cbc:ID': {'_text': tax_category['tax_category_code']},
            'cbc:Percent': {'_text': tax_category['percent']},
...
>>>>>>> upstream/18.0
    def _ubl_get_allowance_charge_global_discount_node(self, vals, global_discount_values):
        ...
        return {
            ...
            'cbc:AllowanceChargeReasonCode': {'_text': '95'},
            'cbc:AllowanceChargeReason': {'_text': _("General discount")},
            'cbc:Amount': {
                '_text': currency.round(abs(amount)),
                'currencyID': currency.name,
            },
            'cac:TaxCategory': [
                self._ubl_get_allowance_charge_global_discount_tax_category_node(vals, tax_category)
...
=======
>>>>>>> upstream/18.0
    def _ubl_add_allowance_charge_nodes_global_discount(self, vals, in_foreign_currency=True):
        AccountTax = self.env['account.tax']
        suffix = '_currency' if in_foreign_currency else ''
        currency = vals['currency'] if in_foreign_currency else vals['company_currency']
        ...
        base_lines_aggregated_values = AccountTax._aggregate_base_lines_tax_details(
            base_lines=vals['base_lines'],
            grouping_function=lambda base_line, tax_data: self._ubl_default_allowance_charge_global_discount_grouping_key(
                base_line=base_line,
                tax_data=tax_data,
                vals=vals,
                currency=currency,
        ...
        for grouping_key, values in values_per_grouping_key.items():
            ...
            allowance_charge_nodes.append(
                self._ubl_get_allowance_charge_global_discount_node(vals, {
                    'currency': currency,
                    'amount': values[f'total_excluded{suffix}'],
                    'tax_categories': {
                        grouping_key: {
...
>>>>>>> upstream/18.0
    def _generate_pdf_attachment(self, invoice, tree):
        ...
        if (
            additional_docs._extract_additional_documents(tree) or
<<<<<<< HEAD
>>>>>>> upstream/18.0
=======
>>>>>>> upstream/18.0
